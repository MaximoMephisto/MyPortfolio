        ...
        <header id="page_description">
            <div class="container">
                <div class="col-12 col-sm-12 mt-5 pt-5">
                    <h1 class="text-light">ABM ventas</h1>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/ambPageOne.png" alt="page">
                            <div class="span">
                                <span class="text-dark">Beautiful</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/ambPageTwo.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/abmPage.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2" data-aos="fade-up">
                        <div class="card h-100 border-light bg-trans">
                            <p class="p-3 text-light">
                                Crud with functionality to insert users, sales, products and customers. Load this data and control annual and monthly billing.
                                <ul class="text-light">
                                    <li>HTML:5</li>
                                    <li>CSS</li>
                                    <li>PHP</li>
