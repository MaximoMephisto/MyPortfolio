        ...
        <header id="page_description">
            <div class="container">
                <div class="col-12 col-sm-12 mt-5 pt-5">
                    <h1 class="text-light">Simple page</h1>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/ctPageOne.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/ctPageTwo.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/ctPage.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2" data-aos="fade-up">
                        <div class="card h-100 border-light bg-trans">
                            <p class="p-3 text-light">
                                Business information and online support.
                                <ul class="text-light">
                                    <li>HTML:5</li>
                                    <li>CSS</li>
                                    <li>PHP</li>
