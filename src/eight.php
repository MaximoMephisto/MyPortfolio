                ...
                <div class="row">
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/byoPageOne.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/byoPageTwo.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/byoPage.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2" data-aos="fade-up">
                        <div class="card h-100 border-light bg-trans">
                            <p class="p-3 text-light">
                                Minimalist commercial page with designs made with javascript.
                                <ul class="text-light">
                                    <li>React.js</li>
                                    <li>CSS</li>
                                    <li>JavaScript</li>
