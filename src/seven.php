        ...
        <header id="page_description">
            <div class="container">
                <div class="col-12 col-sm-12 mt-5 pt-5">
                    <h1 class="text-light">Card creator</h1>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/reactCardPageOne.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/reactCardPageTwo.png" alt="page">
                            <div class="span">
                    ...
                    <div class="col-12 col-sm-6 my-2">
                        <div class="card border-dark" data-aos="fade-up">
                            <img src="../css/images/reactCardPage.png" alt="page">
                            <div class="span">
