                    ...
                    <div class="col-12 col-sm-6 my-2" data-aos="fade-up">
                        <div class="card h-100 border-light bg-trans">
                            <p class="p-3 text-light">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit consequuntur vel laboriosam at necessitatibus cupiditate qui dolores corporis perspiciatis minima, iste similique? Ullam blanditiis adipisci dicta minus sapiente. A, consectetur.
                            </p>
                        </div>
                    </div>
                </div>
